...
int main()
{
    ...
    fobj.InsertLast(11.99f);
    fobj.InsertLast(21.99f);
    fobj.InsertLast(51.99f);
    fobj.InsertLast(101.99f);

    cout << "Linked List of Floats : " << endl;
    fobj.Display();

    dobj.InsertLast(11.99777777);
    dobj.InsertLast(21.99777777);
    dobj.InsertLast(51.99777777);
    dobj.InsertLast(101.9977777);
